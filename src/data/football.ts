...
const seeds: Seed[] = [
  ...
  ["j-cesar","Жулио Сезар","BRA","GK",[],91,"Júlio César (footballer, born 1979)"],["lucio","Лусио","BRA","CB",[],92,"Lúcio"],
  ...
  ["koke","Коке","ESP","CM",["LM"],91,"Koke (footballer, born 1992)"],["gabi","Габи","ESP","CM",["DM"],89,"Gabi (footballer)"],
  ...
  ["dias","Рубен Диаш","POR","CB",[],93,"Rúben Dias"],["rodri","Родри","ESP","DM",["CM"],96,"Rodri (footballer)"],
