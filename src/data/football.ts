...
const seeds: Seed[] = [
  ...
  ["l-garcia","Луис Гарсия","ESP","RW",["AM","RM"],88,"Luis García (footballer, born 1978)"],["hyypia","Сами Хююпия","FIN","CB",[],90,"Sami Hyypiä"],
  ...
  ["zanetti","Хавьер Санетти","ARG","RB",["LB","DM","RWB"],94,"Javier Zanetti"],["sneijder","Уэсли Снейдер","NED","AM",["CM"],94,"Wesley Sneijder"],
  ...
  ["neuer","Мануэль Нойер","GER","GK",[],96,"Manuel Neuer"],["lahm","Филипп Лам","GER","RB",["LB","DM","RWB"],95,"Philipp Lahm"],
  ...
  ["busquets","Серхио Бускетс","ESP","DM",["CM"],95,"Sergio Busquets"],["neymar","Неймар","BRA","LW",["AM","LM"],96,"Neymar"],
  ...
  ["d-costa","Диего Коста","ESP","ST",[],92,"Diego Costa"],["juanfran","Хуанфран","ESP","RB",["RWB"],88,"Juanfran (footballer, born 1985)"],
  ...
  ["fabinho","Фабиньо","BRA","DM",["RB"],92,"Fabinho (footballer, born 1993)"],["mane","Садио Мане","SEN","LW",["ST","LM"],94,"Sadio Mané"],
  ...
  ["di-maria","Анхель Ди Мария","ARG","RW",["AM","RM"],93,"Ángel Di María"],["ederson","Эдерсон","BRA","GK",[],92,"Ederson (footballer, born 1993)"],
  ...
  ["osimhen","Виктор Осимхен","NGA","ST",[],93,"Victor Osimhen"],["di-lorenzo","Джованни Ди Лоренцо","ITA","RB",["RWB"],88,"Giovanni Di Lorenzo"],
